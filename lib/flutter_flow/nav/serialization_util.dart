  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ReadingTableRow:
            return ReadingTableRow(data);
          case WordTableRow:
            return WordTableRow(data);
          case MorningUserRow:
            return MorningUserRow(data);
          case CouponRow:
            return CouponRow(data);
          case MorningCheckRow:
            return MorningCheckRow(data);
          case UserRow:
            return UserRow(data);
          case MorningStudyRow:
            return MorningStudyRow(data);
          case MeRow:
            return MeRow(data);
          case SeriesRow:
            return SeriesRow(data);
          case WordMemoRow:
            return WordMemoRow(data);
          default:
            return null;
        }
